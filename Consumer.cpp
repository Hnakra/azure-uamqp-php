...
Consumer::Consumer(Session *session, std::string resourceName, std::string filter)
{
    ...
    auto selectorFilterKey = amqpvalue_create_symbol("apache.org:selector-filter:symbol");
    auto selectorKey = amqpvalue_create_symbol("apache.org:selector-filter:symbol");
